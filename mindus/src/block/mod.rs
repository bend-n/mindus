...
mods! {
    content defense distribution drills liquid logic payload power production turrets walls units campaign
}
...
make_register! {
    ...
    "landing-pad" => LandingPadBlock::new(4, true, cost!(Copper: 200, Graphite: 100, Titanium: 100));
